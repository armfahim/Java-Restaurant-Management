...
public class TotalBillAdmin extends JFrame implements ActionListener
{
	...
	private double r;
	public TotalBillAdmin()
	{
		super("Dimoke Restaurant - Show Bill (Admin) ");
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==r1)
		{
			BillingAdmin ba=new BillingAdmin();
			ba.setVisible(true);
			setVisible(false);
